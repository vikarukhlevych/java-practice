...
public static void main(String[] args) {
	...
	System.out.println("When false && treu - result is "+ (false && true)); //false
	System.out.println("When fakse && false - result is "+ (false && false)); // false
	...
	System.out.println("WHEN !TRURE - RESULT IS " +(!true));
